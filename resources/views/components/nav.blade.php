...
Note: The (x-data) is from Alpine.js script
--}}
<nav x-data="{ open: false }"
    ...
    <div class="container flex flex-wrap justify-between item-center">
        ...
        {{-- 
        -> humburger button (menu): This will only display in small screens 
        -> @click function from Alpine.js - The button that will click whn you want to show something
        --}}
        ...
        {{-- Another DIV: to show the hidden buttons: login, register, logout --}}
